...
public class PathUtils {
	 ...
	 * @param target what directory you want to go to
	 * @param path the absolute path of your current directory
	 * @param offset walk further up the chain
	 * @return String rebuilt up to the target directory <br><pre>e.g. 1) target = foo, path = bar/foo/ring/ding/ 
	 ...
	 * @param offset how far to walk up the path
	 * @param path the absolute path of your current directory
	 * @return String rebuilt up to the offset amount <br><pre>e.g. offset = 2, path = bar/foo/ring/ding/ 
	 * returns: bar/foo/
	 * </pre>
	 * @throws Exception if offset is longer than path
	 */
