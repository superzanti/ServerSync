...
//        this.getChildren().addAll(labelIgnore, ignoreList);
    ...
    public ComboBox<String> getComboBoxLanguage() {
        if (comboBoxLanguage == null) {
            ...
            comboBoxLanguage.getItems().addAll(
                    ServerSyncUtility.strings.getString("language/english"),
                    ServerSyncUtility.strings.getString("language/spanish"),
                    ServerSyncUtility.strings.getString("language/french"),
                    ServerSyncUtility.strings.getString("language/polish"),
                    ServerSyncUtility.strings.getString("language/russian"),
                    ServerSyncUtility.strings.getString("language/chinese"));
            setDefaultComboxBox();
    ...
    private void changeLanguage(String language) {
        if (language.equals(ServerSyncUtility.strings.getString("language/english"))) {
            I18N.setLocale(new Locale("en", "US"));
        } else if (language.equals(ServerSyncUtility.strings.getString("language/spanish"))) {
            I18N.setLocale(new Locale("es", "ES"));
        } else if (language.equals(ServerSyncUtility.strings.getString("language/french"))) {
            I18N.setLocale(new Locale("fr", "FR"));
        } else if (language.equals(ServerSyncUtility.strings.getString("language/polish"))) {
            I18N.setLocale(new Locale("pl", "PL"));
        } else if (language.equals(ServerSyncUtility.strings.getString("language/russian"))) {
            I18N.setLocale(new Locale("ru", "RU"));
        } else if (language.equals(ServerSyncUtility.strings.getString("language/chinese"))) {
    ...
    private void setDefaultComboxBox(){
        ...
        if (locale.equals(new Locale("en", "US")) || locale.equals(new Locale("en"))) {
            comboBoxLanguage.getSelectionModel().select(ServerSyncUtility.strings.getString("language/english"));
        } else if (locale.equals(new Locale("es", "ES")) || locale.equals(new Locale("es"))) {
            comboBoxLanguage.getSelectionModel().select(ServerSyncUtility.strings.getString("language/spanish"));
        } else if (locale.equals(new Locale("fr", "FR")) || locale.equals(new Locale("fr"))) {
            comboBoxLanguage.getSelectionModel().select(ServerSyncUtility.strings.getString("language/french"));
        } else if (locale.equals(new Locale("pl", "PL")) || locale.equals(new Locale("pl"))) {
            comboBoxLanguage.getSelectionModel().select(ServerSyncUtility.strings.getString("language/polish"));
        } else if (locale.equals(new Locale("ru", "RU")) || locale.equals(new Locale("ru"))) {
            comboBoxLanguage.getSelectionModel().select(ServerSyncUtility.strings.getString("language/russian"));
        } else if (locale.equals(new Locale("zh", "CN")) || locale.equals(new Locale("zh"))) {
            comboBoxLanguage.getSelectionModel().select(ServerSyncUtility.strings.getString("language/chinese"));
        }
    }
}
